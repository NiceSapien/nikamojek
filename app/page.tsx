...
<div className="text-white bg-[#212121] h-[150vh]">
  <p>Sussy baka UwU</p>
  </div>
  <div className="text-white bg-[#212121] justify-center align-center text-center h-[10vh] text-2xl">
  <p>I am NOT weeb. I repeat, I am NOT.</p>
  </div>
</main>
  );
}
